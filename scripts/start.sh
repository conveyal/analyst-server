...
ANALYST_MEM=`echo "$TOTAL_MEM - (8500 * 1024)" | bc`
...
# start the broker.
java8 -Xmx6G -cp /opt/otp/analyst-server.jar com.conveyal.r5.analyst.broker.BrokerMain /etc/broker.conf > /home/ec2-user/broker.log < /dev/null 2>&1 &
